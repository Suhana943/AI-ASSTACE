...
# 1. AI Prompt
prompt = """
Ek latest trending laptop ka data do. Output sirf JSON format mein hona chahiye, koi extra text nahi.
...
# Yahan par replace wala error tha, ise dhyan se copy karein:
